    ...
    <>
      <div className='flex flex-col py-0 px-0 justify-self-auto border-2 border-gray-200 rounded-md shadow-xl'>
        <div className='flex flex-row py-0 px-0 mx-2 my-2'>      
          <img src={props.img} alt='crypto logo' className='pr-2' style={{width: '50px', height: '50px'}} />
          <h2 className='text-4xl font-extrabold text-gray-800 antialiased text-center my-2'>
          {props.name}
          </h2>
        </div>
        <p className='text-base font-light text-gray-800 mx-2 my-2'>Current Price: ${props.price}</p>
